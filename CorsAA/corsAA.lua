...
local enabled_reference = ui.new_combobox("LUA", "B", "Clan tag spammer", {"Off", "gamesense", skeet_tag_name, richgang, hoodbroke, hoodrich, aimheadz, gamesneeze, esoWixxaSENSE, hurensohn, stiegl, ottakring, gosser, punti})
local default_reference = ui.reference("LUA", "B", "Clan tag spammer")
